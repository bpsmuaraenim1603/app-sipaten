            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('leader.evaluation.store') }}" method="POST">
                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        @if (session('success'))
                            <div class="bg-teal-100 border-l-4 border-brand-teal text-teal-800 p-4 rounded-md mb-6"
                                role="alert">
                        ...
                        @endif
                        @if (session('error'))
                            <div class="bg-rose-100 border-l-4 border-brand-rose text-rose-800 p-4 rounded-md mb-6"
                                role="alert">
                            ...
                            <div class="overflow-x-auto border rounded-lg">
                                <table class="w-full">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                                ...
                                                @foreach($criteriaForPegawai as $criterion)
                                                    <td class="px-6 py-4">
                                                        <input type="number"
                                                            ...
                                                            value="{{ $existingScores[$user->id . '-' . $criterion->id] ?? 90 }}"
                                                            class="w-full text-center rounded-md border-gray-900 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                                            min="0" max="100">
                                                    </td>
                                                @endforeach
                                            </tr>
                                        @empty
                                            <tr>
                                                <td colspan="{{ $criteriaForPegawai->count() + 1 }}"
                                                    class="text-center py-4 text-gray-500">Tidak ada data pegawai.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            ...
                            <div class="overflow-x-auto border rounded-lg">
                                <table class="w-full">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="{{ $criteriaForKetuaTim->count() + 1 }}"
                                                    class="text-center py-4 text-gray-500">Tidak ada data ketua tim.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
